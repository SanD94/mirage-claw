...
jq \
  ...
  --arg fizzy_account "$FIZZY_ACCOUNT" \
  ...
  | .models.providers.openrouter.env.FIZZY_ACCOUNT = $fizzy_account
  | .runtime.env.FIZZY_TOKEN = $fizzy_token
  | .runtime.env.FIZZY_ACCOUNT = $fizzy_account
